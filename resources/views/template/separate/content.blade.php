              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukan Judul Film">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Ringkasan</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Masukan Ringkasan Film">
                  </div>
                  <div class="form-group">
